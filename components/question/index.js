...
class App2salesQuestion extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: true,
    ...
    feedback.setProject(this.state.firebaseProject, this.state.baseUrl);
  }
...
App2salesQuestion.defaultProps = {
  title: 'Que tal nos dar um feedback?',
  type: 'questions'
};

export default App2salesQuestion;
